...
[![Coverage](https://img.shields.io/badge/Coverage-0.00%25-red){: width="116" height="20" loading="lazy" decoding="async" }](https://github.com/PedroFnseca/esp32-http-client)
